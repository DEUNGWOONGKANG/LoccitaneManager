      ...
      <div class="w-100 d-flex flex-wrap">
      	...
      	<div style="width:100%">
			  ...
			  <tbody>
			    <tr>
			      <th>쿠폰코드</th>
				  <td><input type="text" placeholder="쿠폰코드" class="form-control" id="cpcode" name="cpcode" style="width:70%"></td>
			    </tr>
			    <tr>
			      <th>쿠폰명</th>
				  <td><input type="text" placeholder="쿠폰명" class="form-control" id="cpname" name="cpname" style="width:70%"></td>
			    </tr>
			    <tr>
			      <th>할인종류</th>
				  <td>
